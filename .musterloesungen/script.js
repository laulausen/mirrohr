...
function getEvents(lastState,counter) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (state != "" + lastState) {	// der berechtigungsstatus hat sich geaendert
//	logo aus und dafuer eine entsprechende meldung einblenden
//	icon entsprechend aendern
	if (state == 0) {	// keine berechtigung
		document.getElementById("meldung").innerHTML = "Bewegungserkennung deaktiviert";
		document.getElementById("home_icon").innerHTML = '<img src="../modules/info/frontend/icons/icon_home.png" style="width:50px;height:50px;">';
	} else {		// berechtigung vorhanden
		document.getElementById("meldung").innerHTML = "Bewegungserkennung aktiviert" ;
		document.getElementById("home_icon").innerHTML = '<img src="../modules/info/frontend/icons/icon_home_bew.png" style="width:50px;height:50px;">';
	}
      }
      else if (counter <= 10) {		// die letzte aenderung des berechtigungsstatus' ist weniger als 10 sek her
	counter++;
      }
      else {				// die letzte aenderung des berechtigungsstatus' ist mehr als 10 sek her
//	meldung aus - und logo wieder einblenden
	document.getElementById("meldung").innerHTML = '<img src="../modules/info/frontend/icons/mirrohr.png" style="width:300px;height:150px;margin: 0px 0px -80px 0px;">';
